...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <a
        href="#experience"
        onClick={() => setClickedNav("#experience")}
      ...
      <a
        href="#services"
        onClick={() => setClickedNav("#services")}
      ...
      <a
        href="#portfolio"
        onClick={() => setClickedNav("#portfolio")}
      ...
      <a
        href="#testimonials"
        onClick={() => setClickedNav("#testimonials")}
      ...
      <a
        href="#contacts"
        onClick={() => setClickedNav("#contacts")}
